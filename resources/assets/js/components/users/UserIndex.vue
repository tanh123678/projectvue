            ...
            <div class="row">
                <div class="col-12">
                    <b-card header="users Lists">
                        ...
                        <b-modal id="modal-prevent" ref="modal" title="Nhập user mới" @ok="handleOk" @shown="clearName">
                            <form @submit.stop.prevent="handleSubmit">
                                <b-form-group label="Nhập name:">
                                    <b-form-input v-model="users.name" type="text" required placeholder="Nhập name nà"></b-form-input>
                                </b-form-group>
                                <b-form-group label="Nhập email name:">
                                    <b-form-input v-model="users.email" type="text" placeholder="Nhập email name nà"></b-form-input>
                                </b-form-group>
                            </form>
                        </b-modal>
                        <b-modal id="modal-edit" ref="myModal" title="Edit user" @ok="handleOkEdit" @shown="clearName">
                            <form @submit.stop.prevent="handleSubmitEdit" @focus.native="handleSubmitEdit()">
                                <b-form-group label="Nhập role:">
                                    <b-form-input v-model="editUser.name" type="text" required placeholder="Nhập name nà"></b-form-input>
                                </b-form-group>
                                <b-form-group label="Nhập email name:">
                                    <b-form-input v-model="editUser.email" type="text" placeholder="Nhập email name nà"></b-form-input>
                                </b-form-group>
                            </form>
                        </b-modal>
                    </b-card>
...
export default {
    data: function() {
        return {
            ...
            editUser: {},
            columns: ["id", "name", "email",'created_at','updated_at', "uri"],
            options: {
                headings: {
                    name: "Name",
                    code: "Emal",
                ...
                sortable: ["id", "name", "email","created_at","updated_at"],
                filterable: ["id", "name", "email","created_at","updated_at"],
