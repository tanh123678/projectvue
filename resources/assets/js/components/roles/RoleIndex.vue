            ...
            <div class="row">
                <div class="col-12">
                    <b-card header="roles Lists">
                        ...
                        <b-modal id="modal-prevent" ref="modal" title="Nhập role mới" @ok="handleOk" @shown="clearName">
                            <form @submit.stop.prevent="handleSubmit">
                                <b-form-group label="Nhập name:">
                                    <b-form-input v-model="roles.name" type="text" required placeholder="Nhập name nà"></b-form-input>
                                </b-form-group>
                                <b-form-group label="Nhập display name:">
                                    <b-form-input v-model="roles.display_name" type="text" placeholder="Nhập display name nà"></b-form-input>
                                </b-form-group>
                            </form>
                        </b-modal>
                        <b-modal id="modal-edit" ref="myModal" title="Edit role" @ok="handleOkEdit" @shown="clearName">
                            <form @submit.stop.prevent="handleSubmitEdit" @focus.native="handleSubmitEdit()">
                                <b-form-group label="Nhập role:">
                                    <b-form-input v-model="editRole.name" type="text" required placeholder="Nhập name nà"></b-form-input>
                                </b-form-group>
                                <b-form-group label="Nhập display name:">
                                    <b-form-input v-model="editRole.display_name" type="text" placeholder="Nhập display name nà"></b-form-input>
                                </b-form-group>
                            </form>
                        </b-modal>
                    </b-card>
